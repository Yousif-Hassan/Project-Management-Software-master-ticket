                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <a href="#" class="pull-right">
                            <img src="<?= base_url('assets/imgs/login_logo.jpg') ?>" alt="rocva.nl">
                        </a>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-10  col-md-offset-1 ">
                                        ...
                                        <div class="form-group">
                                            <input type="submit" class="btn btn-lg btn-danger btn-block red-gradient" name="signin" value="<?= $this->lang_php['sign_in'] ?>">
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" onclick="validEmailCheck()"><?= $this->lang_php['reset'] ?></button>
                </div>
            </div>
        </div>
    </div>
