        ...
        <div class="row">
            ...
            <div class="col-sm-4 the-tracker">
                ...
                <p><b><?= $this->lang_php['costs_to_date'] ?>:</b> <?php
                    ...
                    ?> <a href="javascript:void(0)" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modalConvertor"><?= $this->lang_php['currency_convert'] ?></a></p>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="well well-lg" style="<?= $bg_color ?>">
                                                    ...
                                                    <?php if ($comment['message_from_name'] == null && $comment['message_uid'] == '0' && $comment['send'] == '0') { ?>
                                                        <a class="btn btn-danger btn-circle text-uppercase reply" href="#add-comment" role="tab" data-toggle="tab" data-subfor-id="<?= $comment['id'] ?>">
                                                            <span class="glyphicon glyphicon-share-alt"></span>
                                                            <?= $this->lang_php['reply'] ?>
                                                        </a>
                                                    <?php } if ($this->user_id == $comment['user_id'] && $comment['send'] == '0') { ?>
                                                        <a class="btn btn-danger btn-circle text-uppercase edit" href="javascript:void(0)" title="edit" data-unique-id="<?= $comment['id'] ?>" data-subfor-id="0">
                                                                ...
                                                                <div class="media-body">
                                                                    <div class="well well-lg">
                                                                        ...
                                                                        <?php if ($this->user_id == $sub['user_id']) { ?>
                                                                            <a class="btn btn-danger btn-circle text-uppercase edit" href="javascript:void(0)" title="edit" data-unique-id="<?= $sub['id'] ?>" data-subfor-id="<?= $comment['id'] ?>">
                                                                                <span class="glyphicon glyphicon-pencil"></span>
                                                                                <?= $this->lang_php['edit'] ?>
                                                                            </a>
                ...
                <div class="modal-content">
                    ...
                    <form method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="addtracktime" class="btn btn-danger"><?= $this->lang_php['save_time'] ?></button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade" id="modalConvertor" tabindex="-1" role="dialog" aria-labelledby="modalConvertor">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal"><?= $this->lang_php['close'] ?></button>
                        <button type="button" onclick="currency_ajax_convert('<?= $pph_all ?>')" class="btn btn-danger"><?= $this->lang_php['convert'] ?></button>
                    </div>
                </div>
            </div>
        </div>
