...
<div id="toTop" class="btn btn-danger"><span class="glyphicon glyphicon-chevron-up"></span> <?= $this->lang_php['back_to_top'] ?></div>
<div id="dashboard">
    <div id="loading"></div>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="btn-more pull-right">
                    <button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#advanced-filter">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-danger" onclick="reset()"><?= $this->lang_php['clear'] ?></button>
