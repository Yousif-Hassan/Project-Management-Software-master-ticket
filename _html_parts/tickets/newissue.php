    ...
    <form class="form-horizontal newissue" role="form" method="post" action="" enctype="multipart/form-data">
        ...
        <div class="form-group">        
            <div class="col-sm-offset-2 col-sm-10">
                <button type="submit" name="setticket" class="btn btn-danger"><?= $ticket_edit == false ? $this->lang_php['create'] : $this->lang_php['update'] ?></button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="add-from-list" data-dismiss="modal"><?= $this->lang_php['add'] ?></button>
            </div>
        </div>
    </div>
</div>
