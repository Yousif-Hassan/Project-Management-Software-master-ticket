        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger prev-step" style="display:none;"><?= $this->lang_php['previous'] ?></button>
                    <button type="button" class="btn btn-danger next-step"><?= $this->lang_php['next'] ?></button>
                    <button type="button" class="btn btn-danger" id="create-page" style="display:none;"><?= $this->lang_php['create'] ?></button>
                </div>
            </div>
        </div>
    </div>
