...
<div id="settings">
    <nav class="navbar navbar-settings navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-headers" style="backgeround-color:red;">
            ...
            <div id="navbar" class="navbar-collapse collapse" style="background-color:#FF091C;">
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <form method="GET" action="">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <input type="submit" class="btn btn-danger" value="<?= $this->lang_php['filter_it'] ?>" name="gofilter">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <form method="post" action="">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                                <input type="submit" name="setlanguage" class="btn btn-danger" value="<?= $this->lang_php['save'] ?>">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <form method="post" enctype="multipart/form-data" action="">
                                        <div class="col-xs-8">
                                            <div class="form-group">
                                                ...
                                                <br><label class="col-sm-2 control-label"><?= $this->lang_php['image'] ?></label>
                                                <div class="col-sm-10">
                                        ...
                                        <div class="col-xs-4">
                                            <input type="submit" name="setloginimage" class="btn btn-danger" value="<?= $this->lang_php['save'] ?>">
                                ...
                                <div class="panel-body">
                                    <form method="post" action="">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                                <input type="submit" name="setDefCurrency" class="btn btn-danger" value="<?= $this->lang_php['save'] ?>">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                ...
                if (url_segment(1) !== false && url_segment(1) == 'profiles') {
                    ...
                    <hr>
                    <button type="button" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#addUser">
                                        ...
                                        <form method="GET" action="">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    <button type="submit" class="btn btn-effect-ripple btn-danger"><i class="fa fa-search"></i></button>
                                                </span>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" onclick="validateForm()" class="btn btn-danger"><?= $this->lang_php['save'] ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <hr>
                    <button type="button" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#createModal">
                    ...
                    <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal"><?= $this->lang_php['close'] ?></button>
                                    <button type="button" class="btn btn-danger" onclick="setProject('../add_project')"><?= $this->lang_php['create'] ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <hr>
                    <button type="button" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#addSpace">
                        <?= $this->lang_php['add_space'] ?>
                    </button>
                    <hr>
                    <form method="GET" id="goSelect" action="">
                        <select name="project-filter" data-style="btn-danger" class="selectpicker show-tick show-menu-arrow" id="filter_space" title="Filter by project">
                        ...
                        <div class="modal-dialog" role="document">
                            <form class="form-horizontal" role="form" method="post" id="setSpace" action="" enctype="multipart/form-data">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal"><?= $this->lang_php['close'] ?></button>
                                        <button type="button" class="btn btn-danger" name="setspace" onclick="validateSpace()"><?= $this->lang_php['create'] ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <hr>
                    <button class="btn btn-danger btn-lg" data-target="#addTemplate" data-toggle="modal" type="button"> <?= $this->lang_php['add_template'] ?> </button>
                    <hr>
                        ...
                        <div class="modal-dialog" role="document">
                            <form action="" method="POST">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal"><?= $this->lang_php['close'] ?></button>
                                        <input type="submit" class="btn btn-danger" value="<?= $this->lang_php['save'] ?>" name="addtempl">
                                    </div>
                    ...
                    <div class="panel panel-default panel-table">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col col-xs-6 text-right">
                                    <button type="button"  data-toggle="modal" data-target="#myModalCreateSync" class="btn btn-sm btn-danger btn-create"><?= $this->lang_php['create'] ?></button>
                                </div>
                            </div>
                        </div>
                        <div class="panel-body">
                                            ...
                                            foreach ($emails as $email) {
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <a class="btn btn-danger" onclick="checkConnection(<?= $email['id'] ?>)" data-check-conn="<?= $email['id'] ?>"><?= $this->lang_php['check'] ?> <i class="fa fa-refresh" aria-hidden="true"></i></a>
                                                    </td>
                                                    <td><?= $email['id'] ?></td>
                        ...
                        <div class="panel-footer">
                            <a href="http://php.net/manual/en/book.imap.php" target="_blank"><img src="<?= base_url('assets/imgs/php_logo.png') ?>"></a> - IMAP, POP3 and NNTP | <a href="#" target="_blank"><img src="<?= base_url('assets/imgs/phpmailer_logo.png') ?>"></a>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="myModalCreateSync" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal"><?= $this->lang_php['close'] ?></button>
                                    <button type="button" class="btn btn-danger" id="save"><?= $this->lang_php['save'] ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
