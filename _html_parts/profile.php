        ...
        <nav class="navbar navbar-default main-profile-nav">
            <div class="container-fluid">
                <div class="navbar-header">
                    <button type="button" style="background-color:#FF0000;" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
                        <span class="sr-only">Navigatie aan zetten</span>
                ...
                <div id="navbar" class="navbar-collapse collapse" style="background-color:#FF0000;" >
                        ...
                        if (!isset($_GET['mine-tab']) || $_GET['mine-tab'] == '') {
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="lang" class="form-control" <?= $this->user_lang == null ? 'enabled' : '' ?>>
                                ...
                                <input type="submit" class="btn btn-danger pull-right" name="update" onclick="return validateForm()" value="<?= $this->lang_php['update_info'] ?>">
                            </form>
