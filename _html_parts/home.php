...
<!-- <img src="assets/imgs/login_logo.jpg" width="300" height="150"> -->
<div id="content">
    <div id="home" class="container-fluid">
        ...
        <div class="nav-top-content">
                <a href="javascript:void(0);" data-toggle="modal" data-target="#createModal" data-tooltip="tooltip" data-placement="bottom" title="<?= $this->lang_php['create_new_project'] ?>"><i class="fa-plus-square">CP</i></a>
            <a href="<?= base_url('profile') ?>" data-tooltip="tooltip" data-placement="bottom" title="<?= $this->lang_php['view_profile'] ?>"><i class="fa fa-user"></i>VP</a>
                <a href="<?= base_url('settings') ?>" data-tooltip="tooltip" data-placement="bottom" title="<?= $this->lang_php['open_settings'] ?>"><i class="fa fa-cog"></i>OS</a>
            <a href=" <?= base_url('documentation.html') ?>" target="_blank" data-tooltip="tooltip" data-placement="bottom" title="<?= $this->lang_php['read_docs'] ?>"><i class="fa fa-info-circle">RD</i></a>
            <a href="<?= base_url('logout') ?>" data-tooltip="tooltip" data-placement="bottom" title="<?= $this->lang_php['logout'] ?>"><i class="fa fa-sign-out">LO</i></a>
        </div> 
        ...
        <?php if (!empty($projects)) { ?>
            ...
            <div class="row going">
                ...
                <div class="col-sm-6 text-left bg-choice left" style="background-color:#f0f0f0;">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div id="sync">
                            ...
                            <a href="javascript:void(0);" id="check_conn" class="btn btn-danger"><?= $this->lang_php['check_conn'] ?> <i class="fa fa-refresh" aria-hidden="true"></i></a>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="setProject('add_project')" class="btn btn-danger"><?= $this->lang_php['create'] ?></button>
                </div>
            </div>
        </div>
    </div>
